...
import requests
import pandas as pd
from backend.utils.teamNameMapping import nameMapping
from dotenv import load_dotenv
from pathlib import Path
from backend.services.footballApiService import organizeWinners,processApiDf,addStats,addSeason,addDayCode,addTargetCode,addTeamCodes

dataPath = Path(r"/backend/data")
